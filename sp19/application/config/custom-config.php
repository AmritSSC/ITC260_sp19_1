...
$config['smtp_user'] = 'amrit.dahal@seattlecolleges.edu';
$config['smtp_pass'] = '';
...
$config['recaptcha_sitekey'] = "6Ldzh6MUAAAAACjUGcj6DbztZIzkQZwRlV39XhnS";
$config['recaptcha_secretkey'] = "6Ldzh6MUAAAAAKHzp7yLMmHf7BMD4fG-x7QRa6eY";
$config['lang'] = "";
...
$config['googleMapsKey'] = " AIzaSyBycYwO5isvLvuZjbUSt0_fgxSvQQiFCYc ";
